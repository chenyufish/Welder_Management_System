<template>
  ...
  >
    ...
    >
      ...
      <MachineCardList :machine-list="machineList" @refresh="onRefresh"/>
    </van-list>
  </van-pull-refresh>
  <van-empty image="search" v-if="(!machineList || machineList.length===0) && !listLoading" description="暂无符合要求的设备"/>
